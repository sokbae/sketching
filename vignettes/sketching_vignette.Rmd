...
As before, we first obtain the 2OLS estimate using the full sample. 
...
The 2SLS estimate of the return to education is 0.769 and both types of standard errors are almost the same.  are less precisely estimated than the OLS estimates. Both types of standard errors are almost identical across all sketches for 2SLS. 

We now consider a variety of skecthing schemes.
